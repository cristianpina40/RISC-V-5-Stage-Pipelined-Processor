...
HD_PWD='C:/Users/cp123/datapath1/datapath1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log datapath1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source datapath1.tcl
